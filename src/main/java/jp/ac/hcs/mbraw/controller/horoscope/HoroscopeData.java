...
public class HoroscopeData {
	...
	public enum HoroscopeSign {
		...
		TAURUS("牡牛座", Mapping.RESOURCE_TAURUS_PNG, Mapping.RESOURCE_TAURUS_SVG),
		CANCER("蟹座", Mapping.RESOURCE_CANCER_PNG, Mapping.RESOURCE_CANCER_SVG),
		GEMINI("双子座", Mapping.RESOURCE_GEMINI_PNG, Mapping.RESOURCE_GEMINI_SVG),
